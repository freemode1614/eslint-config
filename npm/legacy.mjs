import { init_esm_shims, custom_default, isUsingPrettier, __toESM, require_lib, require_semver, isESModule, isUsingTypescript, isUsingReact, isUsingJest } from './chunk-24JDKTRL.mjs';
...
var isReactVersionGreaterThan17 = function checkReactVersion() {
  try {
    const reactPackage = (0, import_fs_extra.readJSONSync)(resolve(process.cwd(), "node_modules/react/package.json"));
